...
import com.netcracker.client.services.*;
...
public class MyApplication implements EntryPoint {
    ...
    private static WriteFileServiceAsync writeFileService =
            GWT.create(WriteFileService.class);
    ...
    private class WriteFileCallback implements AsyncCallback {
        @Override
    ...
    public void onModuleLoad() {
        ...
        addButton.addClickHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                if(Validation.validation(title, authorName, authorSurname, pages, publishYear)) {
                    ...
                    pages.setText("");
                    publishYear.setText("");
                    writeFileService.writeFile(lib, new WriteFileCallback());
        ...
        sortByTitleButton.addClickHandler(new ClickHandler() {
            @Override
            public void onClick(ClickEvent event) {
                sortService.sortTable(lib, new SortCallback());
            }
        });
