...
public class Sorting {
    public static void main(String[] args) {
        ...
        System.out.print("\nBubble sorted array: " + Arrays.toString(bubbleArray) +
        ...
        System.out.print("\nSelection sorted array: " + Arrays.toString(selectionArray)+
        ...
        System.out.print("\nSorted with method sort() array: " + Arrays.toString(newArray) +
